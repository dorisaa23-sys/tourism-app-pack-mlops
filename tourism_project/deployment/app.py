...
st.set_page_config(
    page_title="AI-Wellness Tourism Package Prediction App",
    )
st.markdown(
    "<h1 style='font-size: 32px;'>AI-Wellness Tourism Package Prediction App</h1>",
    unsafe_allow_html=True
)
# st.title("Tourism Package Prediction")
st.write("Fill the Customer details below to predict purchase of a travel package")
